...
export async function SinglePost({ id }: { id: string }) {
    ...
    return (
        <>
            <Card className="max-w-3xl lg:max-w-4xl hidden md:flex mx-auto items-center">
                        ...
                        <HoverCard>
                            ...
                            <HoverCardContent>
                                <div className="flex items-center space-x-2">
                                    <UserAvatar className="h-14 w-14" user={post.user} />
                                    <div>
