...
export function ProfileTabs({ profile, isCurrentUser }: ProfileTabsProps) {
            ...
            <TabsList className="p-px bg-zinc-300 dark:bg-neutral-800 h-px w-full gap-x-10">
                {profileTabs
                    ...
                    .map((tab) => {
                        ...
                        return (
                            <TabsTrigger
                                className={cn("flex-col mt-8 gap-4 !p-0 data-[state=active]:text-neutral-400", isActive ? "!text-neutral-700 dark:!text-white" : "text-neutral-400")}
                                key={tab.href}
                                value={tab.href}
                                asChild
                            >
