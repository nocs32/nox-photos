...
export function ProfileForm({ profile }: { profile: UserWithExtras }) {
        ...
        <div className="space-y-8 py-10 lg:p-10 max-w-xl">
            <div className="flex items-center gap-x-2 md:gap-x-5">
                ...
                <div>
                    ...
                    <ProfileAvatar user={profile}>
                        <p className="text-blue-500 text-sm font-bold cursor-pointer dark:hover:text-white hover:text-black">
